...
public class ReviewServiceApplicationTests {
    ...
    private WebTestClient.BodyContentSpec getAndVerifyReviewsByProductId(final int productId, final HttpStatus expectedStatus) {
        return getAndVerifyReviewsByProductId("?productId=" + productId, expectedStatus);
    }

    private WebTestClient.BodyContentSpec getAndVerifyReviewsByProductId(final String productIdQuery, final HttpStatus expectedStatus) {
        return client.get()
    ...
    private WebTestClient.BodyContentSpec postAndVerifyReview(final int productId, final int reviewId, final HttpStatus expectedStatus) {
        final Review review = new Review(productId, reviewId, "Author " + reviewId, "Subject " + reviewId, "Content " + reviewId, "SA");
        return client.post()
                .uri("/review")
    ...
    private WebTestClient.BodyContentSpec deleteAndVerifyReviewsByProductId(final int productId, final HttpStatus expectedStatus) {
